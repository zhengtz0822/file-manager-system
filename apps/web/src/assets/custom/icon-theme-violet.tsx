...
export function IconThemeViolet(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      data-name='icon-theme-violet'
    ...
    >
      ...
      <path
        ...
        fill='#4c1d95'
      />
      <circle cx={6.7} cy={7.04} r={3.54} fill='#8b5cf6' />
      <path
      ...
      <circle cx={62.74} cy={16.32} r={8} fill='#8b5cf6' opacity={0.8} />
      <path
