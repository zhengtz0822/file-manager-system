...
export function IconThemeRed(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      data-name='icon-theme-red'
    ...
    >
      ...
      <path
        ...
        fill='#991b1b'
      />
      <circle cx={6.7} cy={7.04} r={3.54} fill='#ef4444' />
      <path
      ...
      <circle cx={62.74} cy={16.32} r={8} fill='#ef4444' opacity={0.8} />
      <path d='M62.74 16.32l4.1-6.87c1.19.71 2.18 1.72 2.86 2.92s1.04 2.57 1.04 3.95h-8z' fill='#f87171' opacity={0.9} />
      <rect x={29.64} y={27.75} width={41.62} height={18.62} rx={1.69} ry={1.69} fill='#7f1d1d' />
    </svg>
  )
}
